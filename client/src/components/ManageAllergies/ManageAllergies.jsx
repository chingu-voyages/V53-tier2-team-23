...
function ManageAllergies() {
  ...
  useEffect(() => {
    if (chosenEmployeeAllergiesList.length === 1 && chosenEmployeeAllergiesList[0] === 'no allergies') {
  ...
  const handleValidatedNavigation = () => {
    ...
    const allergies = selectedAllergies.length > 0 ? selectedAllergies : preselectedOptions;
