...
function NavBar() {
  return (
    <nav className='flex gap-16 justify-between p-[0.55rem] pt-3.5 pb-[1.7rem] md:px-9 md:pt-9 md:pb-[1.1rem] lg:pl-[5.5rem] lg:pt-[0.5rem] lg:pb-[1.8rem]'>
      <div className='flex '>
        <img
          src={Logo}
          alt='MenuHelp logo'
        ...
        />
        <div className='pt-[1rem] font-bold text-[28px] text-primary md:pt-[1.95rem] md:pl-[1.3rem] lg:pt-[2.25rem] lg:pl-[1.75rem] lg:text-[20px] font-shantell'>
          MenuHelp
        </div>
      </div>
      <div className='items-center gap-8 hidden sm:flex'>
        <ul className='flex gap-[1.55rem] text-[24px] font-medium px-4 pt-5 lg:gap-[4rem] lg:pt-[2.7rem] lg:pr-10'>
          <li>Menus</li>
